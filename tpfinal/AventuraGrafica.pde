class AventuraGrafica {
  ...
  AventuraGrafica() { 
    ...
    this.botonComenzar = new Boton(#B7AD74, "Comenzar",20,210, 280,  180, 250, 140, 50);
    this.botonCreditos = new Boton(#B7AD74, "Creditos",20, 210, 380, 180, 350, 140, 50);
    this.botonReiniciar = new Boton(#CE9455, "Reiniciar", 20, 370, 478,  340, 450, 150, 40);
    this.botonConfesar = new Boton( #58AF8F,"ir a confesar al\ncastillo", 13, 360,455,  340, 430, 150, 50);
    this.botonBosque = new Boton(#58AF8F, "Huir al bosque",13, 30, 460,  10, 430, 150, 50);
