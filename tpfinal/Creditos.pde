class Creditos {
  ...
  int cantPantallas;
  Boton botonReinicio;
  Pantalla [] pantallaCreditos = new Pantalla [10]; 

  int contador, pantalla;

  int direc, walt =0, names2, musica=-10,musica3, pjp=-10, pj2=-0, sec=-30,secp2=0, transparencia;
  ...
  Creditos() {
    ...
    this.botonReinicio = new Boton(#CE9455, "Reiniciar", 20,220,479, 200, 450, 120, 40);
    ...
    this.pantallaCreditos [9] = new Pantalla(9, 13, "©Walt Disney Originals");  
  ...
  void dibujar() {
    if (this.pantalla ==0) {
     ...
     if ((this.direc>60)/*&&(this.direc>=60)*/) {
      ...
      this.pantallaCreditos [9].dibujarPantallaCreditos(180, 430);
